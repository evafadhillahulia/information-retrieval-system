...
data1 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-ayam.csv').dropna()
data2 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-ikan.csv').dropna()
data3 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-kambing.csv').dropna()
data4 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-sapi.csv').dropna()
data5 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-tahu.csv').dropna()
data6 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-telur.csv').dropna()
data7 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-tempe.csv').dropna()
data8 = pd.read_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/dataset-udang.csv').dropna()
...
data.to_csv('/Users/eva/Desktop/Foodienus_ProyekAkhirSTKI/Aplikasi Pencari Resep Masakan/data_praproses.csv', index=False)